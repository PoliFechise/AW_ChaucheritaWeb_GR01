...
<body>
	<div class="contenedor-cuentas">
		...
		<div class="contenedor-botones">
			<div class="boton-crear"
				onclick="location.href='GestionarCuentaController?ruta=crear'">
				<span>Crear</span>
			</div>
			<div class="boton-regresar"
				onclick="location.href='VerTableroController?ruta=ver'">
				<span>Regresar</span>
			</div>
		</div>
	</div>
	...
	<form id="formEliminar" action="GestionarCuentaController" method="get"
		style="display: none;">
